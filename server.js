...
app.get('/scrape/:id', function(req, res){
  ...
  url = 'http://jv.splashstudio.org/appInfoApi.php?packageName='+id;
...
app.get('/selfPromo/:id', function(req, res){
  ...
  var id = req.params.id;
  url = 'http://jv.splashstudio.org/appIconInfo.php?packageName='+id;
...
app.get('/inapp/:id', function(req, res){
  ...
  var id = req.params.id;
  url = 'http://jv.splashstudio.org/appInfoApi_3.php?packageName='+id;
